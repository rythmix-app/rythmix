  ...
  .group(() => {
    router
      .group(() => {
        ...
        router.get('/spotify/login/init', [SpotifyLoginController, 'init'])
        router.get('/spotify/login/callback', [SpotifyLoginController, 'callback'])
        router.get('/google/redirect', [GoogleAuthController, 'redirect'])
        router.get('/google/callback', [GoogleAuthController, 'callback'])
        router.get('/oauth/confirm', [AuthController, 'confirmOAuthLink'])
      })
      .prefix('/auth')
